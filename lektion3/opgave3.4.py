...
KNe_cla = KNeighborsClassifier(n_neighbors=5)
KNe_cla.fit(X_train, y_train)


print("Model is trained")
predictions = KNe_cla.predict(X_test)

# looking at how good our predictor is.
print("Evaluating performance: Cross validation ")

scores = cross_val_score(KNe_cla, X_train, y_train, cv=3, scoring="accuracy")
print(scores)
